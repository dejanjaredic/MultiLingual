...
namespace LanguageOmg.Migrations
{
    public partial class FirstMigraton : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "AnnouncmentPropertyes",
                columns: table => new
                {
                    Id = table.Column<Guid>(nullable: false),
                    Subject = table.Column<string>(nullable: true),
                    PrimaryCategory = table.Column<string>(nullable: true),
                    SecondaryCategory = table.Column<string>(nullable: true),
                    Message = table.Column<string>(nullable: true),
                    LanguageCode = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnnouncmentPropertyes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnnouncmentId = table.Column<Guid>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DeviceUsage_Employees_EmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Devices_MyLanguages_LanguageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Devices_LanguageId",
                table: "Devices",
                column: "LanguageId");

            migrationBuilder.CreateIndex(
                name: "IX_DeviceUsage_EmployeeId",
                table: "DeviceUsage",
                column: "EmployeeId");
